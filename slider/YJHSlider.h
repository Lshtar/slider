...
typedef NS_ENUM(NSInteger,YJHSliderStyle)
{
    YJHSliderStyle_Nomal = 1,    /*默认样式 例如|________|________|________|________|*/
    YJHSliderStyle_Cross = 2,    /*默认样式 例如|--------|--------|--------|--------|*/
    YJHSliderStyle_Point = 3,    /*默认样式 例如 ●--------●--------●--------●--------●*/
};

@interface YJHSlider : UIControl
/**
 刻度样式 详情参考 枚举值 CLSliderStyle 默认 CLSliderStyle_Nomal
 */
@property (nonatomic) YJHSliderStyle sliderStyle;
...
/**
 刻度线 线条横轴颜色
 */
@property (nonatomic) UIColor *scaleLineXColor;
